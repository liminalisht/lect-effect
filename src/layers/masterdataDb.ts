...
export const masterdataDbLayer: Layer.Layer<MasterdataDb, SqlError | ConfigError, ConfigService> = Layer.unwrapEffect(
  Effect.gen(function* () {
    ...
    const sqlClientLayer : Layer.Layer<SqlClient.SqlClient | PgClient.PgClient, SqlError | ConfigError, never> =
