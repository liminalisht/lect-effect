...
declare const ItemRepoService_base: Context.TagClass<ItemRepoService, "services/itemRepo", ItemRepoShape>;
/**
 * Service tag for the item repository.
 * @since 1.0.0
 * @category Services
 */
export declare class ItemRepoService extends ItemRepoService_base {
}
export {};
