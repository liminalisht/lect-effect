 ...
 * @since 1.0.0
 */
export declare class ProductNotFound extends Error {
...
declare const ProductRepoService_base: Context.TagClass<ProductRepoService, "services/productRepo", ProductRepoShape>;
/**
 * Service tag for the product repository.
 * @since 1.0.0
 * @category Services
 */
export declare class ProductRepoService extends ProductRepoService_base {
}
export {};
