 ...
 */
export const getItem = id => Effect.gen(function * () {
...
export const getItemQuery = {
	...
	handler: input => getItem(input.id),
};
/**
 * Lists all items.
 * @since 1.0.0
 ...
 * @category Item Handler Effects
 */
export const createItem = input => Effect.gen(function * () {
	const repo = yield * ItemRepoService;
 ...
 * @category Item Handler Effects
 */
export const productForItem = itemId => Effect.gen(function * () {
 ...
 * @category Item Handlers
 */
export const productForItemField = {
	kind: 'field',
